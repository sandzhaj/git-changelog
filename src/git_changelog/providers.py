...
class Sfera(ProviderRefParser):
    """A parser for the Sfera references."""

    url: str = "https://sfera.inno.local/"
    project_url: str = "{base_url}/sourcecode/projects/{namespace}/repo/{project}"
    tag_url: str = "{base_url}/sourcecode/projects/{namespace}/repos/{project}/code/browse/tag/{ref}"
    ...
    REF: ClassVar[dict[str, RefDef]] = {
        ...
        "merge_requests": RefDef(
            regex=re.compile(RefRe.BB + RefRe.NP + "?pull request\\s*" + RefRe.ID.format(symbol=r"#"), re.I),
            url_string="{base_url}/sourcecode/projects/{namespace}/repos/{project}/pulls/{ref}",
        ),
        "commits": RefDef(
            regex=re.compile(
                RefRe.BB
            ...
            url_string="{base_url}/sourcecode/projects/{namespace}/repos/{project}/code/commits/commit/{ref}/{ref}",
        ),
        "commits_ranges": RefDef(
            regex=re.compile(
                RefRe.BB
            ...
            url_string="{base_url}/sourcecode/projects/{namespace}/repos/{project}/compare?{ref}",
        ),
        "mentions": RefDef(
            regex=re.compile(RefRe.BB + RefRe.MENTION, re.I),
            url_string="{base_url}/{ref}",
